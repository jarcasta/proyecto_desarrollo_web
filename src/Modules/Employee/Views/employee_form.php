...
<form method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['first_name']) ? 'is-invalid' : '' ?>" 
               ...
               value="<?= htmlspecialchars($empleado['first_name'] ?? '') ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['last_name']) ? 'is-invalid' : '' ?>" 
               ...
               value="<?= htmlspecialchars($empleado['last_name'] ?? '') ?>" required>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control <?= isset($errors['date_of_birth']) ? 'is-invalid' : '' ?>" 
               id="date_of_birth" name="date_of_birth" 
               value="<?= htmlspecialchars($empleado['date_of_birth'] ?? '') ?>" required>
    ...
    <div class="mb-3">
        ...
        <?php if (isset($empleado['photo_path']) && $empleado['photo_path']): ?>
            <div class="mb-2">
                <img src="/<?= htmlspecialchars($empleado['photo_path']) ?>"
                     alt="Foto de <?= htmlspecialchars($empleado['first_name'] . ' ' . $empleado['last_name']) ?>"
    ...
    <div class="mb-3">
        ...
        <select class="form-select <?= isset($errors['position_id']) ? 'is-invalid' : '' ?>" 
                id="position_id" name="position_id" required>
            <option value="">Selecciona un puesto</option>
            <?php foreach ($posiciones as $posicion): ?>
                <option value="<?= htmlspecialchars($posicion['id']) ?>" 
                        <?= (isset($empleado['position_id']) && $empleado['position_id'] == $posicion['id']) ? 'selected' : '' ?>>
    ...
    <div class="mb-3">
        ...
        <input type="number" step="0.01" class="form-control <?= isset($errors['salary']) ? 'is-invalid' : '' ?>" 
               ...
               value="<?= htmlspecialchars($empleado['salary'] ?? '') ?>" required>
    ...
    <div class="mb-3">
        ...
        <select class="form-select <?= isset($errors['store_id']) ? 'is-invalid' : '' ?>" 
                id="store_id" name="store_id" required>
            <option value="">Selecciona una tienda</option>
            <?php foreach ($tiendas as $tienda): ?>
                <option value="<?= htmlspecialchars($tienda['id']) ?>" 
                        <?= (isset($empleado['store_id']) && $empleado['store_id'] == $tienda['id']) ? 'selected' : '' ?>>
